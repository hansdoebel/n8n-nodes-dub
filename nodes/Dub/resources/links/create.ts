...
const showForLinksCreate = {
  operation: ["create"],
  resource: ["links"],
};

export const linksCreateDescription: INodeProperties[] = [
  {
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        type: "string",
        default: "",
        description: 'The ID of the link in your database (1-255 characters, prefixed with ext_ for queries)',
      },
      {
      ...
      },
      {
        ...
        type: "string",
        default: "",
        description: 'Geo targeting as JSON object mapping country codes to destination URLs (e.g., {US: https://us.example.com})',
      },
      {
...
function buildLinksCreateBody(this: IExecuteFunctions): IDataObject {
...
export async function linksCreate(
  ...
  const body = buildLinksCreateBody.call(this);

  const response = await dubRequest.call(this, {
    method: "POST",
    url: API_ENDPOINTS.LINKS_CREATE,
    body,
  });
...
export default linksCreateDescription;
